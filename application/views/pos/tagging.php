            ...
            <div class="col-6">
                ...
                <div class="section-tagging">
                    ...
                    <div class="form-group">
                        ...
                        <div class="btn-group-vertical" style="width:100%;">
                            ...
                            <!-- <button type="button" class="btn btn-danger btn-tagger" id="so">Kata Subjek / Objek</button>

                                <button type="button" class="btn btn-success btn-tagger" id="p">Kata Predikat</button>

                                <button type="button" class="btn btn-warning btn-tagger" id="k">Kata Keterangan</button> -->

                            <?php foreach($pos_tags->result() as $tag){ echo '<button type="button"
                ...
                <div class="section-verifying">
                    ...
                    <div class="form-group section-table-tag">
                        ...
                        <table class="table table-tag" data-sortable="true" id="table" data-row-style="rowStyle">
                    ...
                    <div class="form-group" style="display:none;">
                        ...
                        <?=form_open(base_url('ner'), array('id'=>'ner'))?>
                        <!-- <form action="<?=base_url('ner')?>" method="post" id="ner"> -->

                            <input type="hidden" name="artikel" value="<?=$artikel?>" id="nerText">
                            <input type="hidden" name="pos" value="" id="posText">
